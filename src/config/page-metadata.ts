...
export const PAGE_METADATA_MAP = {
  ...
  // about: ABOUT_PAGE_METADATA,  // 已移除 about 版块
  // friends: FRIENDS_PAGE_METADATA,  // 已移除友链版块
  docs: DOCS_PAGE_METADATA,
  // blog: BLOG_PAGE_METADATA,  // 已移除 blog 版块
